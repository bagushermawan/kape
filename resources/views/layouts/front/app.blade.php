...
<head>
    ...
    {{-- <meta name="author" content="Ali - Baher"> --}}
    ...
    <link  href="{{ asset('favicons/favicon.png')}}" rel="shortcut icon" type="image/png">
    {{-- <link rel="shortcut icon" href="{{ asset('favicons/apple-icon-57x57.png')}}" type="image/png"> --}}
